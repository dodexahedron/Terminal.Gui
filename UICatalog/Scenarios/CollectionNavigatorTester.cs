...
[ScenarioCategory ("Controls")] [ScenarioCategory ("ListView")] [ScenarioCategory ("TreeView")] [ScenarioCategory ("Text and Formatting")] [ScenarioCategory ("Mouse and Keyboard")]
	...
	public override void Setup ()
	{
		...
		var menu = new MenuBar (new MenuBarItem [] {
			new ("_Configure", new [] {
				...
				allowMultiSelection,
				null,
				new ("_Quit", $"{Application.QuitKey}", () => Quit (), null, null, (KeyCode)Application.QuitKey)
			}),
