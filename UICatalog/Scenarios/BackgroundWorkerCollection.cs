...
public class BackgroundWorkerCollection : Scenario {
	...
	class OverlappedMain : Toplevel {
		bool canOpenWorkerApp;
		readonly MenuBar menu;
		readonly WorkerApp workerApp;
		...
		public OverlappedMain ()
		{
			...
			menu = new MenuBar (new MenuBarItem [] {
				new ("_Options", new MenuItem [] {
					new ("_Run Worker", "", () => workerApp.RunWorker (), null, null, KeyCode.CtrlMask | KeyCode.R),
					new ("_Cancel Worker", "", () => workerApp.CancelWorker (), null, null, KeyCode.CtrlMask | KeyCode.C),
					null,
					new ("_Quit", "", () => Quit (), null, null, (KeyCode)Application.QuitKey)
				}),
		...
		void OverlappedMain_Deactivate (object sender, ToplevelEventArgs top) => workerApp.WriteLog ($"{top.Toplevel.Data} deactivate.");

		void OverlappedMain_Activate (object sender, ToplevelEventArgs top) => workerApp.WriteLog ($"{top.Toplevel.Data} activate.");
	...
	class WorkerApp : Toplevel {
		readonly ListView listLog;
		readonly List<string> log = new ();
		List<StagingUIController> stagingsUI;
		Dictionary<Staging, BackgroundWorker> stagingWorkers;
