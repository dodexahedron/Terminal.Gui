...
public class ASCIICustomButtonTest : Scenario {
	...
	public override void Init ()
	{
		...
		var menu = new MenuBar (new MenuBarItem [] {
			new ("Window Size", new [] {
				...
				null,
				new ("Quit", "", () => Application.RequestStop (), null, null, (KeyCode)Application.QuitKey)
			})
		});
	...
	public class ASCIICustomButton : Button {
		...
		public ASCIICustomButton (string text, Pos x, Pos y, int width, int height) : base (text) => CustomInitialize ("", text, x, y, width, height);

		public ASCIICustomButton (string id, string text, Pos x, Pos y, int width, int height) : base (text) => CustomInitialize (id, text, x, y, width, height);

		public string Description => $"Description of: {id}";

		public event Action<ASCIICustomButton> PointerEnter;

		void CustomInitialize (string id, string text, Pos x, Pos y, int width, int height)
		{
			this.id = id;
			X = x;
			Y = y;
