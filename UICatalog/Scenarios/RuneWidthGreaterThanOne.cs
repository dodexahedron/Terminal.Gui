...
public class RuneWidthGreaterThanOne : Scenario {
	...
	void MixedMessage (object sender, EventArgs e) => MessageBox.Query ("Say Hello 你", $"Hello {_text.Text}", "Ok");

	void NarrowMessage (object sender, EventArgs e) => MessageBox.Query ("Say Hello", $"Hello {_text.Text}", "Ok");

	void WideMessage (object sender, EventArgs e) => MessageBox.Query ("こんにちはと言う", $"こんにちは {_text.Text}", "Ok");
