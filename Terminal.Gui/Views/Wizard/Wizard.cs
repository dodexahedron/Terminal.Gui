...
/// bottom of the Wizard view are customizable buttons enabling the user to navigate forward and backward through the
/// Wizard.
/// </summary>
/// <remarks>
/// The Wizard can be displayed either as a modal (pop-up) <see cref="Window"/> (like <see cref="Dialog"/>) or as an
/// embedded <see cref="View"/>.
/// 
...
public class Wizard : Dialog {
	...
	bool finishedPressed;

	readonly LinkedList<WizardStep> steps = new ();
	...
	/// <see cref="Run(Func{Exception,bool})"/> has been called
