...
///         </para>
///         <para>
///         Unlike <see cref="ISeries"/>, annotations are allowed to
...
public class LegendAnnotation : View, IAnnotation {
	...
	/// </summary>
	readonly List<Tuple<GraphCellToRender, string>> _entries = new ();
	...
	public void Render (GraphView graph)
	{
		...
		foreach (var entry in _entries) {
			...
			var str = TextFormatter.ClipOrPad (entry.Item2, Bounds.Width - 1);
	...
	/// if outside of Legend <see cref="View.Bounds"/>
	/// </param>
...
public class PathAnnotation : IAnnotation {
	...
	/// </summary>
	/// <returns></returns>
	IEnumerable<LineF> PointsToLines ()
	{
