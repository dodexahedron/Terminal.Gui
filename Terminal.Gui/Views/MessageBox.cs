...
/// <see cref="ErrorQuery(string, string, string[])"/>
...
public static class MessageBox {
	...
	/// <summary>
	/// Presents a normal <see cref="MessageBox"/> with the specified title and message and a list of buttons to show to the
	/// user.
	/// </summary>
	...
	/// </remarks>
	public static int Query (int width, int height, string title, string message, params string [] buttons) => QueryFull (false, width, height, title, message, 0, true, buttons);

	/// <summary>
	/// Presents an error <see cref="MessageBox"/> with the specified title and message and a list of buttons to show to the
	/// user.
	/// </summary>
	/// <returns>The index of the selected button, or -1 if the user pressed ESC to close the dialog.</returns>
	/// <param name="title">Title for the query.</param>
	...
	/// </remarks>
	public static int Query (string title, string message, params string [] buttons) => QueryFull (false, 0, 0, title, message, 0, true, buttons);
	...
	/// contents.
	/// </remarks>
	public static int ErrorQuery (int width, int height, string title, string message, params string [] buttons) => QueryFull (true, width, height, title, message, 0, true, buttons);
	...
	/// </remarks>
	public static int ErrorQuery (string title, string message, params string [] buttons) => QueryFull (true, 0, 0, title, message, 0, true, buttons);
	...
	/// Use <see cref="Query(string, string, string[])"/> instead; it automatically sizes the MessageBox based on the contents.
	/// </remarks>
	public static int Query (int width, int height, string title, string message, int defaultButton = 0, params string [] buttons) => QueryFull (false, width, height, title, message, defaultButton, true, buttons);
	...
	/// from the size of the message and buttons.
	/// </remarks>
	public static int Query (string title, string message, int defaultButton = 0, params string [] buttons) => QueryFull (false, 0, 0, title, message, defaultButton, true, buttons);
	...
	/// Use <see cref="Query(string, string, string[])"/> instead; it automatically sizes the MessageBox based on the contents.
	/// </remarks>
	public static int Query (int width, int height, string title, string message, int defaultButton = 0, bool wrapMessagge = true, params string [] buttons) => QueryFull (false, width, height, title, message, defaultButton, wrapMessagge, buttons);
	...
	/// from the size of the message and buttons.
	/// </remarks>
	public static int Query (string title, string message, int defaultButton = 0, bool wrapMessage = true, params string [] buttons) => QueryFull (false, 0, 0, title, message, defaultButton, wrapMessage, buttons);
	...
	/// contents.
	/// </remarks>
	public static int ErrorQuery (int width, int height, string title, string message, int defaultButton = 0, params string [] buttons) => QueryFull (true, width, height, title, message, defaultButton, true, buttons);
	...
	/// from the size of the title, message. and buttons.
	/// </remarks>
	public static int ErrorQuery (string title, string message, int defaultButton = 0, params string [] buttons) => QueryFull (true, 0, 0, title, message, defaultButton, true, buttons);
	...
	/// contents.
	/// </remarks>
	public static int ErrorQuery (int width, int height, string title, string message, int defaultButton = 0, bool wrapMessagge = true, params string [] buttons) => QueryFull (true, width, height, title, message, defaultButton, wrapMessagge, buttons);
	...
	/// from the size of the title, message. and buttons.
	/// </remarks>
	public static int ErrorQuery (string title, string message, int defaultButton = 0, bool wrapMessagge = true, params string [] buttons) => QueryFull (true, 0, 0, title, message, defaultButton, wrapMessagge, buttons);
