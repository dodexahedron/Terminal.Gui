...
/// </summary>
/// <remarks>
/// This class wraps another <see cref="ITableSource"/> and dynamically
...
public abstract class CheckBoxTableSourceWrapperBase : ITableSource {
	...
	/// The <see cref="TableView"/> this source will be used with.
	/// This is required for event registration.
	/// </param>
	/// <param name="toWrap">
	/// The original data source of the <see cref="TableView"/> that you
	...
	void TableView_MouseClick (object sender, MouseEventEventArgs e)
	{
		...
		var hit = tableView.ScreenToCell (e.MouseEvent.X, e.MouseEvent.Y, out var headerIfAny);
	...
	void TableView_CellToggled (object sender, CellToggledEventArgs e)
	{
