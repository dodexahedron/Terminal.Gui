...
public class SelectedCellChangedEventArgs : EventArgs {
	...
	/// <summary>
	/// The current table to which the new indexes refer.  May be null e.g. if selection change is the result of clearing the
	/// table from the view
	/// </summary>
	/// <value></value>
	...
	/// <summary>
	/// The previous selected column index.  May be invalid e.g. when the selection has been changed as a result of replacing
	/// the existing Table with a smaller one
	/// </summary>
	/// <value></value>
	...
	/// <summary>
	/// The previous selected row index.  May be invalid e.g. when the selection has been changed as a result of deleting rows
	/// from the table
	/// </summary>
	/// <value></value>
