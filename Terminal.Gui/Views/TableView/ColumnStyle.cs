...
public class ColumnStyle {
	...
	/// <para>
	/// This value will be ignored if more than the tables <see cref="TableView.MaxCellWidth"/>
	...
	/// <summary>
	/// Returns the full string to render (which may be truncated if too long) that the current style says best represents the
