...
public class CheckBox : View {
	...
	/// <summary>
	/// Initializes a new instance of <see cref="CheckBox"/> based on the given text, using <see cref="LayoutStyle.Computed"/>
	/// layout.
	/// </summary>
	...
	/// text length.
	/// </remarks>
	public CheckBox (int x, int y, string s, bool is_checked) : base (new Rect (x, y, s.Length, 1)) => SetInitialProperties (s, is_checked);
	...
	Rune GetCheckedState () => Checked switch {
		true => _charChecked,
