...
class FileSystemInfoStats {
	...
	*/
	...
	static readonly List<string> ImageExtensions = new() { ".JPG", ".JPEG", ".JPE", ".BMP", ".GIF", ".PNG" };
	static readonly List<string> ExecutableExtensions = new() { ".EXE", ".BAT" };
	...
	static string GetHumanReadableFileSize (long value, CultureInfo culture)
	{
