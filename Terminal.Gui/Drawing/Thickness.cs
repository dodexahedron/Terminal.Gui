...
public class Thickness : IEquatable<Thickness> {
	...
	/// <summary>
	/// Gets the total height of the top and bottom sides of the rectangle. Sets the height of the top and bottom sides of the
	/// rectangle to half the specified value.
	/// </summary>
	public int Vertical {
		get => Top + Bottom;
	...
	/// <summary>
	/// Gets the total width of the left and right sides of the rectangle. Sets the width of the left and rigth sides of the
	/// rectangle to half the specified value.
	/// </summary>
	...
	public bool Equals (Thickness other) => other is not null &&
	                                        Left == other.Left &&
	                                        Right == other.Right &&
	                                        Top == other.Top &&
	                                        Bottom == other.Bottom;

	int validate (int width)
	{
		if (width < 0) {
	...
	/// </summary>
	/// <remarks>
	/// If a thickness width is negative, the inside rectangle will be larger than <paramref name="rect"/>. e.g.
	/// a
	/// <c>
	/// Thickness (-1, -1, -1, -1) will result in a rectangle skewed -1 in the X and Y directions and
	/// with a Size increased by 1.
	/// </c>
	/// </remarks>
	...
	/// <inheritdoc/>
	public static bool operator == (Thickness left, Thickness right) => EqualityComparer<Thickness>.Default.Equals (left, right);
