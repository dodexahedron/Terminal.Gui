...
public class LineCanvas : IDisposable {
	...
	readonly List<StraightLine> _lines = new ();

	readonly Dictionary<IntersectionRuneType, IntersectionRuneResolver> runeResolvers = new() {
	...
	void ConfigurationManager_Applied (object? sender, ConfigurationManagerEventArgs e)
	{
	...
	public Dictionary<Point, Rune> GetMap (Rect inArea)
	{
		...
		for (var y = inArea.Y; y < inArea.Y + inArea.Height; y++) {
			for (var x = inArea.X; x < inArea.X + inArea.Width; x++) {
	...
	Rune? GetRuneForIntersects (ConsoleDriver driver, IntersectionDefinition? [] intersects)
	{
		if (!intersects.Any ()) {
			return null;
		}
	...
	Attribute? GetAttributeForIntersects (IntersectionDefinition? [] intersects) => intersects [0]!.Line.Attribute;

	Cell? GetCellForIntersects (ConsoleDriver driver, IntersectionDefinition? [] intersects)
	{
		if (!intersects.Any ()) {
			return null;
		}
	...
	IntersectionRuneType GetRuneTypeForIntersects (IntersectionDefinition? [] intersects)
	{
	...
	bool All (IntersectionDefinition? [] intersects, Orientation orientation) => intersects.All (i => i!.Line.Orientation == orientation);
	...
	/// <returns></returns>
	bool Has (HashSet<IntersectionType> intersects, params IntersectionType [] types) => types.All (t => intersects.Contains (t));
	...
	/// <param name="types"></param>
	/// <returns></returns>
	bool Exactly (HashSet<IntersectionType> intersects, params IntersectionType [] types) => intersects.SetEquals (types);
	...
	abstract class IntersectionRuneResolver {
		...
		public Rune? GetRuneForIntersects (ConsoleDriver driver, IntersectionDefinition? [] intersects)
		{
			...
			var doubleHorizontal = intersects.Any (l => l?.Line.Orientation == Orientation.Horizontal && l.Line.Style == LineStyle.Double);
			var doubleVertical = intersects.Any (l => l?.Line.Orientation == Orientation.Vertical && l.Line.Style == LineStyle.Double);

			var thickHorizontal = intersects.Any (l => l?.Line.Orientation == Orientation.Horizontal && (
				l.Line.Style == LineStyle.Heavy || l.Line.Style == LineStyle.HeavyDashed || l.Line.Style == LineStyle.HeavyDotted));
			var thickVertical = intersects.Any (l => l?.Line.Orientation == Orientation.Vertical && (
				l.Line.Style == LineStyle.Heavy || l.Line.Style == LineStyle.HeavyDashed || l.Line.Style == LineStyle.HeavyDotted));
	...
	class ULIntersectionRuneResolver : IntersectionRuneResolver {
	...
	class URIntersectionRuneResolver : IntersectionRuneResolver {
		public override void SetGlyphs ()
		{
	...
	class LLIntersectionRuneResolver : IntersectionRuneResolver {
		public override void SetGlyphs ()
		{
	...
	class LRIntersectionRuneResolver : IntersectionRuneResolver {
		public override void SetGlyphs ()
		{
	...
	class TopTeeIntersectionRuneResolver : IntersectionRuneResolver {
		public override void SetGlyphs ()
		{
	...
	class LeftTeeIntersectionRuneResolver : IntersectionRuneResolver {
		public override void SetGlyphs ()
		{
	...
	class RightTeeIntersectionRuneResolver : IntersectionRuneResolver {
		public override void SetGlyphs ()
		{
	...
	class BottomTeeIntersectionRuneResolver : IntersectionRuneResolver {
		public override void SetGlyphs ()
		{
	...
	class CrossIntersectionRuneResolver : IntersectionRuneResolver {
		public override void SetGlyphs ()
		{
			_round = Glyphs.Cross;
