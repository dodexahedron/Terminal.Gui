...
///                         <term>SubView</term>
///                         <description>
///                                 A View that is contained in another view and will be rendered as part of the containing
///                                 view's
///                                 ContentArea.
///                                 SubViews are added to another view via the <see cref="View.Add(View)" />` method. A
///                                 View may only be a
...
///         </list>
///         <para>
///                 Focus is a concept that is used to describe which View is currently receiving user input. Only Views
///                 that are
...
///         </para>
///         <para>
///                 View supports two layout styles: <see cref="LayoutStyle.Absolute" /> or
...
///                 then the layout style is <see cref="LayoutStyle.Computed" />. Otherwise it is
///                 <see cref="LayoutStyle.Absolute" />.
///         </para>
///         <para>
///                 To create a View using Absolute layout, call a constructor that takes a
///                 Rect parameter to specify the absolute position and size or simply set <see cref="View.Frame " />). To
///                 create a View
///                 using Computed layout use a constructor that does not take a Rect parameter and set the X, Y, Width and
///                 Height
...
///                 <see cref="Height" /> properties are <see cref="Dim" /> and <see cref="Pos" /> objects that dynamically
///                 update the
///                 position of a view.
...
///         </para>
///         <para>
///                 To flag a region of the View's <see cref="Bounds" /> to be redrawn call
///                 <see cref="SetNeedsDisplay(Rect)" />.
...
///                 set at construction time. If a <see cref="ColorScheme" /> is not set on a view, the view will inherit
///                 the
...
///                 <see cref="ISupportInitializeNotification" />
...
public partial class View : Responder, ISupportInitializeNotification {
	...
	/// <remarks>
	///         <para>
	///                 Use <see cref="X" />, <see cref="Y" />, <see cref="Width" />, and <see cref="Height" /> properties to
	///                 dynamically
	...
	/// <para>
	///         If first-run-only initialization is preferred, overrides to
	///         <see cref="ISupportInitializeNotification.IsInitialized" />
	///         can be implemented, in which case the <see cref="ISupportInitialize" />
	///         methods will only be called if <see cref="ISupportInitializeNotification.IsInitialized" />
	///         is <see langword="false" />. This allows proper <see cref="View" /> inheritance hierarchies
	///         to override base class layout code optimally by doing so only on first run,
