...
public partial class View {
    ...
    public void BringSubviewForward (View subview) => PerformActionForSubview (
                                                                               subview,
                                                                               x => {
    ...
    public void BringSubviewToFront (View subview) => PerformActionForSubview (
                                                                               subview,
                                                                               x => {
                                                                                   _subviews.Remove (x);
                                                                                   _subviews.Add (x);
    ...
    /// <param name="subview">The subview to send backwards</param>
    /// <remarks>If you want to send the view all the way to the back use SendSubviewToBack.</remarks>
    public void SendSubviewBackwards (View subview) => PerformActionForSubview (
                                                                                subview,
                                                                                x => {
                                                                                    var idx = _subviews.IndexOf (x);
                                                                                    if (idx > 0) {
    ...
    public void SendSubviewToBack (View subview) => PerformActionForSubview (
                                                                             subview,
                                                                             x => {
                                                                                 _subviews.Remove (x);
...
#region Focus
    ...
    /// <summary>Gets a value indicating whether this <see cref="View" /> has focus.</summary>
    ...
    /// <returns>
    ///   <see langword="true" /> if previous was focused, <see langword="false" /> otherwise.
    /// </returns>
