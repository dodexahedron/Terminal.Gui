...
public class SeriesTests {
	...
	class FakeSeries : ISeries {
		...
		public void DrawSeries (GraphView graph, Rect bounds, RectangleF graphBounds) => drawSeries (graph, bounds, graphBounds);
	}
}
...
public class BarSeriesTests {
	...
	class FakeBarSeries : BarSeries {
		...
		protected override GraphCellToRender AdjustColor (GraphCellToRender graphCellToRender) => FinalColor = base.AdjustColor (graphCellToRender);
