...
Item 6", output);
	...
	class NewListDataSource : IListDataSource {
		...
		public void Render (ListView container, ConsoleDriver driver, bool selected, int item, int col, int line, int width, int start = 0) => throw new NotImplementedException ();
