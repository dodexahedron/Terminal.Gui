...
public class TextViewTests
{
    ...
    public void AllowsReturn_Setting_To_True_Changes_Multiline_To_True_If_It_Is_False ()
    {
        ...
        _textView.NewKeyDownEvent (new (Key.Enter));
        ...
        Application.Iteration += (s, a) =>
                                 {
                                     ...
                                     {
                                         col--;
                                         _textView.NewKeyDownEvent (new (Key.Tab.WithShift));
                                         Assert.Equal (new Point (col, 0), _textView.CursorPosition);
                                         leftCol = GetLeftCol (leftCol);
                                         Assert.Equal (leftCol, _textView.LeftColumn);
                                     }
                                     ...
                                     {
                                         col++;
                                         _textView.NewKeyDownEvent (new (Key.Tab));
                                         Assert.Equal (new Point (col, 0), _textView.CursorPosition);
                                         leftCol = GetLeftCol (leftCol);
                                         Assert.Equal (leftCol, _textView.LeftColumn);
                                     }
    ...
    public void BottomOffset_Sets_To_Zero_Adjust_TopRow ()
    {
        ...
        tv.NewKeyDownEvent (new (Key.End.WithCtrl));
    ...
    public void ContentsChanged_Event_Fires_ClearHistoryChanges ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.Enter)));
    ...
    public void ContentsChanged_Event_Fires_On_Typing ()
    {
        ...
        expectedCol = 1;
        tv.NewKeyDownEvent (new (Key.Y.WithShift));
    ...
    public void ContentsChanged_Event_Fires_On_Undo_Redo ()
    {
        ...
        expectedEventCount++;
        Assert.True (_textView.NewKeyDownEvent (new (Key.Enter)));
        Assert.Equal (expectedEventCount, eventcount);

        // Undo
        expectedEventCount++;
        Assert.True (_textView.NewKeyDownEvent (new (new (Key.Z.WithCtrl))));
        Assert.Equal (expectedEventCount, eventcount);

        // Redo
        expectedEventCount++;
        Assert.True (_textView.NewKeyDownEvent (new (new (Key.R.WithCtrl))));
        Assert.Equal (expectedEventCount, eventcount);
    ...
    public void Copy_Or_Cut_And_Paste_With_No_Selection ()
    {
        ...
        _textView.NewKeyDownEvent (new (new (Key.C.WithCtrl))); // Copy
        ...
        _textView.NewKeyDownEvent (new (new (Key.Y.WithCtrl))); // Paste
        ...
        _textView.SelectionStartRow = 0;
        _textView.NewKeyDownEvent (new (new (Key.W.WithCtrl))); // Cut
        Assert.Equal (new Point (24, 0), _textView.CursorPosition);
        Assert.False (_textView.Selecting);
    ...
    public void Cut_Not_Allowed_If_ReadOnly_Is_True ()
    {
        ...
        _textView.NewKeyDownEvent (new (Key.W.WithCtrl)); // Selecting is set to false after Cut.
        Assert.Equal ("", _textView.SelectedText);
...
",
        ...
        {
            Assert.True (tv.NewKeyDownEvent (new (new (Key.Z.WithCtrl))));
        }
...
",
        ...
        Assert.Equal (new Point (2, 0), tv.CursorPosition);
        Assert.True (tv.NewKeyDownEvent (new (Key.Delete)));
        tv.Draw ();
        Assert.Equal (new Point (2, 0), tv.CursorPosition);
...
",
    ...
    public void HistoryText_IsDirty_HasHistoryChanges ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.D1)));
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.D2)));
        Assert.Equal ($"1{Environment.NewLine}2", tv.Text);
        Assert.Equal (2, tv.Lines);
    ...
    public void HistoryText_Undo_Redo_Changing_On_Middle_Clear_History_Forwards ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.D3)));
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.D4)));
        Assert.Equal ("124", tv.Text);
        Assert.Equal (1, tv.Lines);
        Assert.Equal (new Point (3, 0), tv.CursorPosition);

        // Redo
        Assert.True (tv.NewKeyDownEvent (new (new (Key.R.WithCtrl))));
        Assert.Equal ("124", tv.Text);
        Assert.Equal (1, tv.Lines);
        Assert.Equal (new Point (3, 0), tv.CursorPosition);
    }
    ...
    public void HistoryText_Undo_Redo_Copy_Without_Selection_Multi_Line_Paste ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.C.WithCtrl)));
        ...
        Assert.True (tv.NewKeyDownEvent (new (new (Key.Y.WithCtrl))));
    ...
    public void HistoryText_Undo_Redo_Cut_Multi_Line_Another_Selected_Paste ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (new (Key.W.WithCtrl))));
    ...
    public void HistoryText_Undo_Redo_Disabled_On_WordWrap ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.A)));
    ...
    public void HistoryText_Undo_Redo_KillToEndOfLine ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (new (Key.K.WithCtrl))));
    ...
    public void HistoryText_Undo_Redo_KillToStartOfLine ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.End.WithCtrl)));
        Assert.Equal ($"First line.{Environment.NewLine}Second line.", tv.Text);
        Assert.Equal ("", tv.SelectedText);
        Assert.Equal (2, tv.Lines);
        Assert.Equal (new Point (12, 1), tv.CursorPosition);

        Assert.True (tv.NewKeyDownEvent (new (Key.K.WithAlt)));
    ...
    public void HistoryText_Undo_Redo_KillWordBackward ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.Backspace.WithCtrl)));
        Assert.Equal ($"First line.{Environment.NewLine}Second line", tv.Text);
        Assert.Equal ("", tv.SelectedText);
        Assert.Equal (2, tv.Lines);
    ...
    public void HistoryText_Undo_Redo_KillWordForward ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.Delete.WithCtrl)));
    ...
    public void HistoryText_Undo_Redo_Multi_Line_Selected_All_Return_And_InsertText ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.End.WithCtrl.WithShift)));
    ...
    public void HistoryText_Undo_Redo_Multi_Line_Selected_With_Empty_Text ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.O.WithShift)));
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.E)));
    ...
    public void HistoryText_Undo_Redo_Multiline_Selected_Tab_BackTab ()
    {
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.Tab)));
        Assert.Equal ("First \tline.", tv.Text);
        Assert.Equal (1, tv.Lines);
        Assert.Equal (new Point (7, 0), tv.CursorPosition);

        Assert.True (tv.NewKeyDownEvent (new (Key.Tab.WithShift)));
        Assert.Equal ("First line.", tv.Text);
        Assert.Equal (1, tv.Lines);
        Assert.Equal (new Point (6, 0), tv.CursorPosition);
    ...
    public void KeyBindings_Command ()
    {
        ...
        tv.CanFocus = true;
        Assert.False (tv.NewKeyDownEvent (new (Key.CursorLeft)));
        ...
        Assert.Equal (new Point (23, 2), tv.CursorPosition);
        Assert.False (tv.NewKeyDownEvent (new (Key.CursorRight)));
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.PageDown.WithShift)));
        Assert.Equal (28, tv.GetCurrentLine ().Count);
        Assert.Equal (new Point (23, 2), tv.CursorPosition); // gets the previous length
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        Assert.True (tv.NewKeyDownEvent (new (Key.Home.WithCtrl)));
        Assert.Equal (Point.Empty, tv.CursorPosition);
        Assert.True (tv.NewKeyDownEvent (new (Key.N.WithCtrl)));
        Assert.Equal (new Point (0, 1), tv.CursorPosition);
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        Assert.True (tv.NewKeyDownEvent (new (new (Key.P.WithCtrl))));
        Assert.Equal (Point.Empty, tv.CursorPosition);
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        ...
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        Assert.True (tv.NewKeyDownEvent (new (Key.CursorDown.WithShift)));
        Assert.Equal (new Point (0, 1), tv.CursorPosition);
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.CursorUp.WithShift)));
        Assert.Equal (Point.Empty, tv.CursorPosition);
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        Assert.True (tv.NewKeyDownEvent (new (new (Key.F.WithCtrl))));
        Assert.Equal (new Point (1, 0), tv.CursorPosition);
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        Assert.True (tv.NewKeyDownEvent (new (new (Key.B.WithCtrl))));
        Assert.Equal (Point.Empty, tv.CursorPosition);
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        Assert.True (tv.NewKeyDownEvent (new (Key.CursorRight)));
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.CursorRight.WithShift)));
        Assert.Equal (new Point (1, 0), tv.CursorPosition);
        Assert.Equal (1, tv.SelectedLength);
        Assert.Equal ("T", tv.SelectedText);
        Assert.True (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (Key.CursorLeft.WithShift)));
        Assert.Equal (Point.Empty, tv.CursorPosition);
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        Assert.True (tv.Selecting);
        ...
        Assert.Equal ("", tv.SelectedText);
        Assert.False (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (Key.D.WithCtrl)));
        ...
        Assert.Equal (Point.Empty, tv.CursorPosition);
        Assert.True (tv.NewKeyDownEvent (new (Key.End)));
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.Home)));
        Assert.Equal (Point.Empty, tv.CursorPosition);
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        Assert.False (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (Key.End.WithShift)));
        Assert.Equal (new Point (19, 0), tv.CursorPosition);
        Assert.Equal (19, tv.SelectedLength);
        Assert.Equal ("is is the first lin", tv.SelectedText);
        Assert.True (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (Key.Home.WithShift)));
        Assert.Equal (Point.Empty, tv.CursorPosition);
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        Assert.True (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (Key.E.WithCtrl)));
        Assert.Equal (new Point (19, 0), tv.CursorPosition);
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        Assert.False (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (Key.A.WithCtrl)));
        Assert.Equal (Point.Empty, tv.CursorPosition);
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        Assert.False (tv.Selecting);
        ...
        Assert.Equal ("is is the first lin", Clipboard.Contents);
        tv.CursorPosition = Point.Empty;
        Assert.True (tv.NewKeyDownEvent (new (Key.Delete.WithCtrl.WithShift)));
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.Space.WithCtrl)));
        ...
        Assert.Equal (0, tv.SelectionStartRow);
        Assert.Equal ("is is the first lin", Clipboard.Contents);
        Assert.True (tv.NewKeyDownEvent (new (Key.W.WithCtrl)));
        ...
        Assert.True (tv.NewKeyDownEvent (new (Key.X.WithCtrl)));
        ...
        Assert.Equal ("", tv.SelectedText);
        Assert.False (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (Key.CursorLeft.WithCtrl)));
        ...
        Assert.Equal ("", tv.SelectedText);
        Assert.False (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (Key.CursorLeft.WithShift.WithCtrl)));
        ...
        Assert.Equal ("", tv.SelectedText);
        Assert.False (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (Key.CursorRight.WithCtrl)));
        ...
        Assert.Equal ("", tv.SelectedText);
        Assert.False (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (Key.CursorRight.WithShift.WithCtrl)));
        ...
        Assert.Equal (Point.Empty, tv.CursorPosition);
        Assert.False (tv.Selecting);
        Assert.False (tv.NewKeyDownEvent (new (Key.Enter)));
        Assert.Equal ($"This is the second line.{Environment.NewLine}This is the third ", tv.Text);
        Assert.Equal (Point.Empty, tv.CursorPosition);
        Assert.Equal (0, tv.SelectedLength);
        Assert.Equal ("", tv.SelectedText);
        ...
        Assert.False (tv.Selecting);
        Assert.True (tv.AllowsReturn);
        Assert.True (tv.NewKeyDownEvent (new (Key.End.WithShift.WithCtrl)));
        ...
        Assert.True (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (Key.Home.WithShift.WithCtrl)));
        ...
        Assert.True (tv.Selecting);
        Assert.True (tv.NewKeyDownEvent (new (new (Key.T.WithCtrl))));
        ...
        Assert.True (tv.Selecting);
        Assert.True (tv.Used);
        Assert.True (tv.NewKeyDownEvent (new (Key.InsertChar)));
        Assert.False (tv.Used);
        Assert.True (tv.AllowsTab);
        Assert.Equal (new Point (18, 2), tv.CursorPosition);
        tv.AllowsTab = false;
        Assert.False (tv.NewKeyDownEvent (new (Key.Tab)));
        ...
        Assert.True (tv.AllowsTab);
        tv.AllowsTab = false;
        Assert.False (tv.NewKeyDownEvent (new (Key.Tab.WithShift)));
        ...
        Assert.True (tv.AllowsTab);
        Assert.False (tv.NewKeyDownEvent (new (Key.Tab.WithCtrl)));
        Assert.False (tv.NewKeyDownEvent (new (Application.AlternateForwardKey)));
        Assert.False (tv.NewKeyDownEvent (new (Key.Tab.WithCtrl.WithShift)));
        Assert.False (tv.NewKeyDownEvent (new (Application.AlternateBackwardKey)));

        Assert.True (tv.NewKeyDownEvent (new (ContextMenu.DefaultKey)));
    ...
    public void Kill_Delete_WordBackward ()
    {
        ...
        {
            _textView.NewKeyDownEvent (new (Key.Backspace.WithCtrl));
    ...
    public void Kill_Delete_WordForward ()
    {
        ...
        while (!iterationsFinished)
        {
            _textView.NewKeyDownEvent (new (Key.Delete.WithCtrl));
    ...
    public void Kill_To_End_Delete_Forwards_Copy_To_The_Clipboard_And_Paste ()
    {
        ...
        while (!iterationsFinished)
        {
            ...
            {
                case 0:
                    _textView.NewKeyDownEvent (new (new (Key.K.WithCtrl)));
                    Assert.Equal (0, _textView.CursorPosition.X);
                    Assert.Equal (0, _textView.CursorPosition.Y);
                    ...
                    break;
                case 1:
                    _textView.NewKeyDownEvent (new (new (KeyCode.Delete | KeyCode.CtrlMask | KeyCode.ShiftMask)));
                    Assert.Equal (0, _textView.CursorPosition.X);
                    Assert.Equal (0, _textView.CursorPosition.Y);
                    Assert.Equal ("This is the second line.", _textView.Text);
                ...
                case 2:
                    ...
                    // Paste
                    _textView.NewKeyDownEvent (new (new (Key.Y.WithCtrl)));
    ...
    public void Kill_To_Start_Delete_Backwards_Copy_To_The_Clipboard_And_Paste ()
    {
        ...
        while (!iterationsFinished)
        {
            ...
            {
                case 0:
                    _textView.NewKeyDownEvent (new (Key.K.WithAlt));
                    Assert.Equal (0, _textView.CursorPosition.X);
                    Assert.Equal (1, _textView.CursorPosition.Y);
                    Assert.Equal ($"This is the first line.{Environment.NewLine}", _textView.Text);
                    ...
                    break;
                case 1:
                    _textView.NewKeyDownEvent (new ( new(KeyCode.Backspace | KeyCode.CtrlMask | KeyCode.ShiftMask)));
                    Assert.Equal (23, _textView.CursorPosition.X);
                    Assert.Equal (0, _textView.CursorPosition.Y);
                    Assert.Equal ("This is the first line.", _textView.Text);
    ...
    public void RightOffset_Sets_To_Zero_Adjust_leftColumn ()
    {
        ...
        tv.NewKeyDownEvent (new (Key.End));
    ...
    public void Selected_Text_Shows ()
    {
        ...
        _textView.NewKeyDownEvent (new (Key.CursorRight.WithCtrl.WithShift));
        ...
        Application.Iteration += (s, a) =>
                                 {
                                     ...
                                     {
                                         col--;
                                         _textView.NewKeyDownEvent (new (Key.CursorLeft));
                                         Assert.Equal (new Point (col, 0), _textView.CursorPosition);
                                         leftCol = GetLeftCol (leftCol);
                                         Assert.Equal (leftCol, _textView.LeftColumn);
                                     }
                                     ...
                                     {
                                         col++;
                                         _textView.NewKeyDownEvent (new (Key.CursorRight));
                                         Assert.Equal (new Point (col, 0), _textView.CursorPosition);
                                         leftCol = GetLeftCol (leftCol);
                                         Assert.Equal (leftCol, _textView.LeftColumn);
                                     }
        ...
        Application.Iteration += (s, a) =>
                                 {
                                     ...
                                     _textView.NewKeyDownEvent (new (Key.Home));
                                     col = 0;
                                     Assert.Equal (new Point (col, 0), _textView.CursorPosition);
                                     leftCol = 0;
                                     Assert.Equal (leftCol, _textView.LeftColumn);

                                     _textView.NewKeyDownEvent (new (Key.End));
...
TAB to jump between text field",
    ...
    public void TextChanged_Event_NoFires_OnTyping ()
    {
        ...
        _textView.Text = "ay";
        Assert.Equal (1, eventcount);
        _textView.NewKeyDownEvent (new (Key.Y.WithShift));
        Assert.Equal (1, eventcount);
...
",
    ...
    public void WordBackward_Multiline_With_Selection ()
    {
        ...
        while (!iterationsFinished)
        {
            _textView.NewKeyDownEvent (new (Key.CursorLeft.WithCtrl.WithShift));
    ...
    public void WordBackward_With_No_Selection ()
    {
        ...
        {
            _textView.NewKeyDownEvent (new (Key.CursorLeft.WithCtrl));
    ...
    public void WordForward_Multiline_With_Selection ()
    {
        ...
        while (!iterationsFinished)
        {
            _textView.NewKeyDownEvent (new (new (KeyCode.CursorRight | KeyCode.CtrlMask | KeyCode.ShiftMask)));
    ...
    public void WordForward_With_No_Selection ()
    {
        ...
        {
            _textView.NewKeyDownEvent (new (Key.CursorRight.WithCtrl));
...
Line 2.",
        ...
        Assert.True (_textView.NewKeyDownEvent (new (Key.End.WithShift)));
        Assert.Equal ("Line 1.", _textView.SelectedText);

        Assert.True (_textView.NewKeyDownEvent (new (new (del))));
        Application.Refresh ();
        TestHelpers.AssertDriverContentsWithFrameAre ("Line 2.", _output);

        Assert.True (_textView.NewKeyDownEvent (new (Key.H.WithShift)));
