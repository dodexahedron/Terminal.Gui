...
";
	...
	public void ShortCut_Activates ()
	{
		...
		var menu = new MenuBar (new MenuBarItem [] {
			new ("_File", new MenuItem [] {
				new ("_Save", "Saves the file.", () => { saveAction = true; }, null, null, KeyCode.S | KeyCode.CtrlMask)
			})
		});
...
└──────────────────────────────────────┘", _output);
		...
		menu.Menus = new MenuBarItem [] {
			new ("File", new MenuItem [] {
				new (items [0], "Create a new file", () => ChangeMenuTitle ("New"), null, null, KeyCode.CtrlMask | KeyCode.N),
				new (items [1], "Open a file", () => ChangeMenuTitle ("Open"), null, null, KeyCode.CtrlMask | KeyCode.O),
				new (items [2], "Close a file", () => ChangeMenuTitle ("Close"), null, null, KeyCode.CtrlMask | KeyCode.C),
				new (items [3], "Save a file", () => ChangeMenuTitle ("Save"), null, null, KeyCode.CtrlMask | KeyCode.S),
				new (items [4], "Save a file as", () => ChangeMenuTitle ("Save As"), null, null, KeyCode.CtrlMask | KeyCode.A),
				new (items [5], "Delete a file", () => ChangeMenuTitle ("Delete"), null, null, KeyCode.CtrlMask | KeyCode.A)
			})
		};
		dialog.Add (menu);
