...
public class ContextMenuTests {
	...
	public ContextMenuTests (ITestOutputHelper output) => this.output = output;
	...
	ContextMenu Create_ContextMenu_With_Two_MenuItem (int x, int y) => new (x, y,
		new MenuBarItem (new MenuItem [] {
			new ("One", "", null),
			new ("Two", "", null)
		})
