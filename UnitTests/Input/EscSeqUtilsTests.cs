...
public class EscSeqUtilsTests {
	...
	void ProcessContinuousButtonPressed (MouseFlags arg1, Point arg2)
	{
		this.arg1 = arg1;
		this.arg2 = arg2;
		actionStarted = true;
	...
	public void GetMouse_Tests ()
	{
		...
		EscSeqUtils.GetMouse (cki, out var mouseFlags, out var pos, ProcessContinuousButtonPressed);
		Assert.Equal (new List<MouseFlags> { MouseFlags.Button1Pressed }, mouseFlags);
		Assert.Equal (new Point (1, 2), pos);
