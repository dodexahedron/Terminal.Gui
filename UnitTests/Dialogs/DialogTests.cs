...
└──────────────────┘"
        ...
        Iteration += (s, a) =>
                     {
                         ...
                         if (iterations == 0)
                         {
                             Assert.True (btn1.NewKeyDownEvent (new (Key.Space)));
                         }
                         else if (iterations == 1)
                         {
                             expected = @$"
  ...
  └───────────────────────┘";
                             ...
                             Assert.True (btn2.NewKeyDownEvent (new (Key.Space)));
                         }
  ...
  └───────────────────────┘",
                             ...
                             Assert.True (Current.NewKeyDownEvent (new (Key.Enter)));
                         }
                         else if (iterations == 3)
                         {
                             TestHelpers.AssertDriverContentsWithFrameAre (expected, _output);

                             Assert.True (btn3.NewKeyDownEvent (new (Key.Space)));
                         }
